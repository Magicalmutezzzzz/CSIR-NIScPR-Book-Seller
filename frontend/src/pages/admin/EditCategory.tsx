...
export default function EditCategory() {
  const [formData, setFormData] = useState({
    name: "Books",
    description:
      "Books published by CSIR-NIScPR covering science, technology and research.",
    icon: "BookOpen",
    color: "#003366",
    status: "Active",
  });
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-500">
            Update publication category information.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <div className="mt-2 flex justify-between text-sm text-gray-500">
                ...
                <span>
                  This description will be visible in the admin dashboard.
                </span>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <label className="flex items-center justify-between rounded-2xl border p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Highlight this category across the portal.
                    </p>
            ...
            <div className="md:col-span-2">
              ...
              <div className="grid gap-5 md:grid-cols-3">
                ...
                <div className="rounded-2xl border bg-blue-50 p-5">
                  ...
                  <h4 className="mt-2 text-3xl font-bold text-[#003366]">
                    42
                  </h4>
